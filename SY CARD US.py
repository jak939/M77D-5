...
def express() :
 ...
 try :
   for az in range(int(zz)) :
    ...
    print(az+1,")","E"+ urname1.upper(),"M 7 D")
...
def Norton() :
 ...
 try :
   for az in range(int(zz)) :
    ...
    print(az+1,")",'V'+gothar69.upper()," M 7 D")
...
Name : Mohanad huj ali
 ...
 if zack == '1':
    ...
    print("  Go To https://www.facebook.com/profile.php?id=100000763891219&mibextid=kFxxJD")
 elif zack == '69' :
    abo()
 else :
